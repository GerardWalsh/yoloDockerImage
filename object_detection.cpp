...
void drawPred(int classId, float conf, int left, int top, int right, int bottom, Mat& frame, std::string fileName);
...
void drawPred(int classId, float conf, int left, int top, int right, int bottom, Mat& frame, std::string fileName)
{
	...
	//std::string label = format("%.2f", conf);	
	//std::cout << "Prediction"<< std::endl <<  label << std::endl;
	//std::cout << classId << std::endl;
	//std::cout << label << std::endl;
	filename = classes[classId];
